...
const Proyect = ({ name, company,project_link, period, description }) => {
  return (
    <div className="experience__content">
      ...
      <div className="experience__data bd-grid">
        ...
        {name} {project_link && <a href={project_link} target="_blank" rel="noreferrer"><i class='bx bx-link-external'></i></a>}
        </h3>
